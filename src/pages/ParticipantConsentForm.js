        ...
        <div className="consent-form-container">
            <form onSubmit={handleSubmit} className="consent-form">
                ...
                <ol className="consent-list">
                    <li>I have read the Participant Information Sheet and my questions have been answered satisfactorily.</li>
                    ...
                    <li>Relevant personnel from [Your Institution Name] or regulatory authorities may review the collected data as part of their duty.</li>
